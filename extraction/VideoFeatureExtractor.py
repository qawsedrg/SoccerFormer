...
class VideoFeatureExtractor():
    ...
    def extractFeatures(self, path_video_input, path_features_output, start=None, duration=None, overwrite=False):
        ...
        if "TF2" in self.back_end:
            ...
            features = self.model.predict(frames, batch_size=16, verbose=1)
...
if __name__ == "__main__":
    ...
    for file in os.listdir("../data/"):
        ...
        path_features="../data/{:}.npy".format('.'.join(file.split(".")[:-1]))
        myFeatureExtractor.extractFeatures(path_video_input=path_video,
        ...
        if args.PCA is not None or args.PCA_scaler is not None:
            ...
            myPCAReducer.reduceFeatures(input_features=path_features,
                                        output_features=path_features,
                                        overwrite=args.overwrite)